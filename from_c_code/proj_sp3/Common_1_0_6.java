...
abstract class Common_1_0_6 {
	...
	List<SPResource_1_0_6> resourcesRequired;
	...
	Common_1_0_6() {
		...
		meleeAC = 10;
		rangedAC = 10;
		resourcesRequired = new ArrayList<SPResource_1_0_6>();
		currentHitPoints = 1;
		currentLevel = 1;
		currentExperience = 0;
	...
	Common_1_0_6(final Common_1_0_6 rhs) {
		...
		resourcesRequired = new ArrayList<SPResource_1_0_6>(rhs
	...
	List<SPResource_1_0_6> getResourcesRequired() {
		return resourcesRequired;
	}

	boolean setResourcesRequired(final List<SPResource_1_0_6> rr) {
		resourcesRequired = new ArrayList<SPResource_1_0_6>(rr);
		return true;
	}
