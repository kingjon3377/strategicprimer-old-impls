...
public class GameGUIDriver extends JFrame implements ActionListener, 
	 ...
	 */
	private static final long serialVersionUID = 21121290594787761L;
	/**
	...
	private static void setUpTestUnits() {
		...
		Game.getGame().buildUnit(Game.getGame().getPlayer(), Game.getGame().getMap().getTile(1, 1),
				"Phalanx", BuildConstants.PHALANX_HP,
				BuildConstants.PHALANX_HP, BuildConstants.PHALANX_SPEED,
				BuildConstants.PHALANX_DEFENSE,
				BuildConstants.PHALANX_ACCURACY, BuildConstants.PHALANX_ATTACK,
				BuildConstants.PHALANX_RANGED, BuildConstants.PHALANX_COST);
		Game.getGame().buildUnit(Game.getGame().getPlayer(), Game.getGame().getMap().getTile(1, 2),
				"Cavalry", BuildConstants.CAVALRY_HP,
				BuildConstants.CAVALRY_HP, BuildConstants.CAVALRY_SPEED,
				BuildConstants.CAVALRY_DEFENSE,
				BuildConstants.CAVALRY_ACCURACY, BuildConstants.CAVALRY_ATTACK,
		...
		Game.getGame().buildUnit(Game.getGame().getPlayer(), Game.getGame().getMap().getTile(4, 4),
				"Phalanx", BuildConstants.PHALANX_HP,
				BuildConstants.PHALANX_HP, BuildConstants.PHALANX_SPEED,
				BuildConstants.PHALANX_DEFENSE,
				BuildConstants.PHALANX_ACCURACY, BuildConstants.PHALANX_ATTACK,
				BuildConstants.PHALANX_RANGED, BuildConstants.PHALANX_COST);
		Game.getGame().buildUnit(Game.getGame().getPlayer(), Game.getGame().getMap().getTile(4, 3),
				"Cavalry", BuildConstants.CAVALRY_HP,
				BuildConstants.CAVALRY_HP, BuildConstants.CAVALRY_SPEED,
				BuildConstants.CAVALRY_DEFENSE,
				BuildConstants.CAVALRY_ACCURACY, BuildConstants.CAVALRY_ATTACK,
