...
public final class LabelPanel extends JPanel {
	 ...
	 */
	private static final long serialVersionUID = -5840019017911098317L;
	/**
	...
	public void updateLabels() {
		...
		unitLabel.setText((Game.getGame().getTile1() == null)
				|| (Game.getGame().getTile1().getModuleOnTile() == null) ? "No unit selected"
				: Game.getGame().getTile1().getModuleOnTile().toString());
