...
public final class MapPanel extends JPanel {
	 ...
	 */
	private static final long serialVersionUID = 7189413379530576845L;
	/**
	 * The graphical tiles that make up the map
	 */
	private final GUITile[][] tiles;
	/**
	 * How many rows of tiles there are.
	 */
	private final int numRows;
	/**
	 * How many columns of tiles there are.
	 */
	...
	/**
	 * How many columns we are off of (0,0).
	 */
	private transient int offsetX;

	/**
	 * How many rows we are off of (0,0).
	 */
