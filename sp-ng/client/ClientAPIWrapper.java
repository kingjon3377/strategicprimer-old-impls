...
public class ClientAPIWrapper {
	 ...
	 * @throws IOException
	 *             on I/O error setting up streams
	 */
	 ...
	 * @return the message received
	 * @throws ClassNotFoundException
	 *             when deserialization of the reply fails
	 * @throws IOException
	 *             on I/O error
	 */
	public ProtocolMessage call(final ProtocolMessage message)
	 ...
	 * 
	 * @param host
	 *            the host to connect to. (The "if not up" logic assumes it's
	 *            the local host.)
	 * @param port
	 ...
	 * @throws IOException
	 *             on I/O error after starting the server
	 * @throws UnknownHostException
	 *             when localhost is unknown
	 */
	public static Socket connect(final InetAddress host, final int port,
			final int cport) throws UnknownHostException, IOException {
		// ESCA-JAVA0177:
		Socket sock;
		try {
